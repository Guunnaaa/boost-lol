...
# --- FONCTION RESTAURÉE : DETERMINE PLAYSTYLE ---
def determine_playstyle(stats, role, lang_dict):
    badges = []
    if stats['kda'] >= 4.0: badges.append(("🛡️ " + lang_dict.get("q_surv", "KDA").split(" ")[0], "b-gold"))
    ...
    if stats['dmg_min'] >= 800: badges.append(("⚔️ " + lang_dict.get("q_dmg", "Dmg").split(" ")[0], "b-red"))
    if stats['obj'] >= 5000: badges.append(("🏰 " + lang_dict.get("q_obj", "Obj").split(" ")[0], "b-gold"))
