...
st.markdown(
    ...
    .main-title {{
        font-size: 60px; font-weight: 900; color: #ffffff; text-align: center; margin-bottom: 20px;
...
T = TRANSLATIONS.get(selected_code, TRANSLATIONS["EN"])
